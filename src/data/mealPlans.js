...
export const mealPlans = [
  ...
  },
  {
    ...
    days: [
      day([{ type: 'Breakfast', slug: 'overnight-oats-protein' }, { type: 'Lunch', slug: 'quinoa-black-bean-bowl' }, { type: 'Dinner', slug: 'turkey-vegetable-stir-fry' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['berries', 'pumpkinSeeds', 'apple', 'toast', 'almonds'])),
      ...
      day([{ type: 'Breakfast', slug: 'greek-yogurt-protein-bowl' }, { type: 'Lunch', slug: 'lentil-vegetable-soup' }, { type: 'Dinner', slug: 'salmon-roasted-vegetables' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['oatcakes', 'hummus', 'pear', 'walnuts', 'milk'])),
      day([{ type: 'Breakfast', slug: 'overnight-oats-protein' }, { type: 'Lunch', slug: 'mediterranean-chickpea-salad' }, { type: 'Dinner', slug: 'sweet-potato-lentil-curry' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['boiledEgg', 'berries', 'walnuts', 'toast', 'apple'])),
      ...
      day([{ type: 'Breakfast', slug: 'chia-pudding-berries' }, { type: 'Lunch', slug: 'quinoa-black-bean-bowl' }, { type: 'Dinner', slug: 'baked-cod-sweet-potato' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['hummus', 'pumpkinSeeds', 'orange', 'toast', 'walnuts'])),
  ...
  },
  {
    ...
    days: [
      ...
      day([{ type: 'Breakfast', slug: 'chia-pudding-berries' }, { type: 'Lunch', slug: 'greek-chicken-bowl' }, { type: 'Dinner', slug: 'tofu-vegetable-buddha-bowl' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['milk', 'orange', 'oatcakes', 'cheese'])),
      day([{ type: 'Breakfast', slug: 'veggie-omelette' }, { type: 'Lunch', slug: 'lentil-vegetable-soup' }, { type: 'Dinner', slug: 'baked-cod-sweet-potato' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['greekYogurt', 'walnuts', 'apple'])),
      day([{ type: 'Breakfast', slug: 'greek-yogurt-protein-bowl' }, { type: 'Lunch', slug: 'mediterranean-chickpea-salad' }, { type: 'Dinner', slug: 'teriyaki-salmon-rice' }, { type: 'Snack', slug: 'peanut-butter-energy-balls' }], ex(['cheese', 'pear', 'almonds'])),
      day([{ type: 'Breakfast', slug: 'overnight-oats-protein' }, { type: 'Lunch', slug: 'lemon-herb-chicken-salad' }, { type: 'Dinner', slug: 'tofu-vegetable-buddha-bowl' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['milk', 'pumpkinSeeds', 'berries'])),
      day([{ type: 'Breakfast', slug: 'chia-pudding-berries' }, { type: 'Lunch', slug: 'quinoa-black-bean-bowl' }, { type: 'Dinner', slug: 'salmon-roasted-vegetables' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['greekYogurt', 'almonds', 'toast'])),
      day([{ type: 'Breakfast', slug: 'avocado-egg-toast' }, { type: 'Lunch', slug: 'chicken-vegetable-soup' }, { type: 'Dinner', slug: 'chickpea-spinach-curry' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['cheese', 'walnuts', 'orange'])),
    ],
  },
  {
    ...
    relatedCalculator: { name: 'Protein Calculator', href: '/calculators/protein/' },
    days: [
      day([{ type: 'Breakfast', slug: 'egg-white-veggie-scramble' }, { type: 'Lunch', slug: 'lemon-herb-chicken-salad' }, { type: 'Dinner', slug: 'shrimp-garlic-zucchini-noodles' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['berries', 'toast', 'avocadoHalf'])),
      day([{ type: 'Breakfast', slug: 'greek-yogurt-protein-bowl' }, { type: 'Lunch', slug: 'chicken-vegetable-soup' }, { type: 'Dinner', slug: 'turkey-vegetable-stir-fry' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['apple', 'riceExtra', 'almonds'])),
      day([{ type: 'Breakfast', slug: 'egg-white-veggie-scramble' }, { type: 'Lunch', slug: 'greek-chicken-bowl' }, { type: 'Dinner', slug: 'baked-cod-sweet-potato' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['greekYogurt', 'oatcakes', 'walnuts'])),
      ...
      day([{ type: 'Breakfast', slug: 'veggie-omelette' }, { type: 'Lunch', slug: 'chicken-vegetable-soup' }, { type: 'Dinner', slug: 'turkey-meatballs-tomato-sauce' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['berries', 'oatcakes', 'riceExtra', 'almonds'])),
      day([{ type: 'Breakfast', slug: 'greek-yogurt-protein-bowl' }, { type: 'Lunch', slug: 'lemon-herb-chicken-salad' }, { type: 'Dinner', slug: 'salmon-roasted-vegetables' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['pear', 'toast', 'hummus'])),
      day([{ type: 'Breakfast', slug: 'egg-white-veggie-scramble' }, { type: 'Lunch', slug: 'lentil-vegetable-soup' }, { type: 'Dinner', slug: 'turkey-vegetable-stir-fry' }, { type: 'Snack', slug: 'cottage-cheese-fruit-bowl' }], ex(['greekYogurt', 'berries', 'riceExtra', 'walnuts'])),
    ],
  },
];
